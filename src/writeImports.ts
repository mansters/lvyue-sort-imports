...
export default function getSortedImportStatements(importClauses: TypescriptImport[]) {
...
function generatedNamedImportGroup(namedImports: NamedImport[]): string {
    ...
    let maxImportsPerSingleLine = options.getMaxNamedImportsPerSingleLine() as number;
